...
export default function BlockInTextExample() {
  return (
    <div className="flex h-screen items-center justify-center bg-neutral-100 px-8 py-24 text-neutral-800">
      <BlockInTextCard
        ...
        text={
          <>
            <strong>Have questions?</strong> We&apos;d love to help! Contact support for any issue that you may face.
          </>
        }
        examples={[
...
const BlockInTextCard = ({
  ...
  return (
    <div className="w-full max-w-xl space-y-6">
      <div>
        <p className="mb-1.5 text-sm font-light upperacase">
          {tag}
        </p>
